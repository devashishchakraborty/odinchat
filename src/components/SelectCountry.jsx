...
const SelectCountry = forwardRef((props, ref) => {
  return (
    <select
      ref={ref}
      name="country"
      className="form-control w-95 rounded-lg border-2 border-gray-200 bg-gray-100 p-2 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
      id="country"
    >
